      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 lg:px-10">
        <div className="flex flex-col items-center gap-6 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="-mb-32 flex justify-center lg:justify-start lg:pl-12">
              <img
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-rose-400 to-pink-400 px-5 py-2.5 text-sm font-medium text-white shadow-md shadow-rose-200/50 transition-all hover:scale-105 hover:shadow-lg hover:shadow-rose-300/40"
            >
